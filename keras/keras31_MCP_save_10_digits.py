# keras31_MCP_save_10_digits.py
# 구조 : keras30_ModelCheckPoint1.py 기준 / 데이터, 모델 : keras28_Scaler10_digits.py
# 짝 파일 : keras32_MCP_load_10_digits.py
#   이 파일이 저장한 keras31_mcp10.keras 를 keras32 가 불러와서 평가하면 아래 결과와 소수점까지 같아야 한다.
...
mcp = ModelCheckpoint(
    ...
    filepath=path + 'keras31_mcp10.keras',  # 파일 번호 규칙 : 10 -> mcp10
    verbose=1,
)
