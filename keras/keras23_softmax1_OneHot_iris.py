...
'''
OneHot Encording은 모델을 구성하거나 훈련하는 작업이 아니라,
학습에 사용할 정답 데이터 y의 형태를 바꾸는 전처리 과정이기 때문에
#1. 데이터 에서 처리하는 게 맞음
'''
########## OneHot Encording 1. (tensorflow) ##########
...
########## OneHot Encording 2. (pandas) - 선생님 코드 ##########
# y = pd.get_dummies(y, dtype=int)
# print(y)


########## OneHot Encording 3. (sklearn) ##########
