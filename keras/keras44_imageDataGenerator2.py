...
print(x_train.shape, x_test.shape)  # (160, 22500) (120, 22500)
...
model.summary()
# Total params: 11,717,617
#  -> 첫 층 22500 x 512 + 512 = 11,520,512 로 전체의 98% 를 차지한다
