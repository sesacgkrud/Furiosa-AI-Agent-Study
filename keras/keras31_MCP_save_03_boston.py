# keras31_MCP_save_03_boston.py
# 구조 : keras30_ModelCheckPoint1.py 기준 / 데이터, 모델 : keras28_Scaler03_boston.py
# 짝 파일 : keras32_MCP_load_03_boston.py
#   이 파일이 저장한 keras31_mcp3.keras 를 keras32 가 불러와서 평가하면 아래 결과와 소수점까지 같아야 한다.
...
mcp = ModelCheckpoint(
    ...
    filepath=path + 'keras31_mcp3.keras',   # keras32 가 불러와야 하므로 고정 이름 사용
    verbose=1,
)
