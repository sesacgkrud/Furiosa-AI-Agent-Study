...
# (원래는 빠져 있어서 categorical_crossentropy 가 확률이 아닌 값으로 계산됐고 acc 가 0.09 로 떨어졌다)
...
# 함수형 (이전 실행, softmax 누락 상태)                 loss : 0.24131235480308533 / acc : 0.09 / acc_score : 0.09003333333333334
