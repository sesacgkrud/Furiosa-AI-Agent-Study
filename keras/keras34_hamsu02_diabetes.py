...
# ===== 이전 기록 =====
# Sequential + Dropout (keras33_dropout02, 2026-09-14)  loss : 3112.50927734375 / r2 : 0.45746572147891085

# ===== 실행 결과 (2026-09-14, 함수형 + Dropout + MCP + r2/mse/rmse, keras33 과 같은 구성) =====
# loss : 3296.8359375
# r2 : 0.4253361867331049
# mse : 3296.8362582069876
# RMSE : 57.41808302448792
# (Epoch 104: early stopping / Restoring model weights from the end of the best epoch: 84.)
