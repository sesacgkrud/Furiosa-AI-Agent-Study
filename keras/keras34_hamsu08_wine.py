...
# (원래 변환에서는 Dropout 이 100 뒤 0.3 / 50 뒤 0.3 / 10 뒤 0.3 으로 keras33 과 달랐다 -> keras33 대로 200 뒤 0.4, 100 뒤 0.2 두 개만)
...
# ===== 이전 기록 =====
# Sequential + Dropout (keras33_dropout08, 2026-09-14)      loss : 0.10924266278743744 / accuracy_score : 0.9629629629629629
# 함수형 (이전 실행, softmax 누락 + Dropout 구성 다른 상태)  loss : 0.7975386381149292 / accuracy_score : 0.8518518518518519

# ===== 실행 결과 (2026-09-14, 함수형 + Dropout + MCP + r2/mse/rmse, keras33 과 같은 구성으로 수정 후) =====
# loss : 0.2270108312368393
# acc : 0.944
# r2 : 0.8537247921335821
# mse : 0.032417908572332704
# RMSE : 0.18004973916207906
# accuracy_score : 0.9444444444444444
# (Epoch 151: early stopping / Restoring model weights from the end of the best epoch: 101.)
